...
from fidutils import get_inception_score, get_softmax, normalize_img
...
def calculate_fid_is_given_paths(paths, inception_path):
    ...
    with tf.Session() as sess:
        ...
        m2, s2, is_score2, is_std2 = _handle_path(paths[1], sess, norm=False)
...
if __name__ == "__main__":
    ...
    fid_value, is_score1, is_score2 = calculate_fid_is_given_paths(args.path, args.inception)

    print("FID: ", fid_value)
    print('IS Score of path 1: {}'.format(is_score1))
    print('IS Score of path 2: {}'.format(is_score2))
